...
|---|---|---|---|
| `Observer / Memory` | сбор телеметрии, баг-репортов, скриншотов, векторизация в RAG | строго локально | скорость инференса, мультимодальность (зрение), низкий reasoning |
